...
int main(){
  ...
  printf("\nIl valore massimo  Pre Order :");
  outputItem(getMaxValuePreOrder(bh));
  printf("\nIl valore massimo inOrder : ");
  outputItem(getMaxValueInOrder(bh));
  printf("\nIl valore massimo Ricorsivo ");
  outputItem(getMaxValueRecursive(bh));
  return 0;
}
