...
int main(){
  ...
  bo=buildTree(NULL,NULL,"h"); //o
  bq=buildTree(NULL,NULL,"h"); //q
  ...
  List list=newList();
  printf("\nCi sono %d elemnti distinti nella versione iterativa .",countDistinctRecursive(bh,list));
  printf("\nVersione iterativa , ci sono %d elementi distinti\n",countDistinctIterative(bh));
